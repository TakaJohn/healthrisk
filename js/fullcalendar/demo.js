    ...
    $('.calendar').each(function() {
      $(this).fullCalendar({
        ...
        events: [
          ...
          {
            title: 'Lunch THIS IS A VERY LONG EVENT DESCRIPTION HERE THIS IS A VERY LONG EVENT DESCRIPTION HERETHIS IS A VERY LONG EVENT DESCRIPTION HERETHIS IS A VERY LONG EVENT DESCRIPTION HERE',
